...
def is_ocr_garbage_token(token: str) -> bool:
    ...
    # 3 блоков — это покрывает легитимные «Тенsar», артикулы вроде
    # «ТriАх160» (кирилл-латин-кирилл) и «B30F300» (в арт-кодах цифры
    # естественно разрывают буквенный блок).
    if _script_runs(core) >= 4:
        return True
    return False
